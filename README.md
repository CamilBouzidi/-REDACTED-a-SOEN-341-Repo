...
# Firebase Readme
[Firebase](https://firebase.google.com/docs?gclid=CjwKCAiAp5nyBRABEiwApTwjXqaQx6mWmRh3j0u5M2hpbwp7Yf-eXdSorcYctKEZkoxqqvy951RnnBoC6-QQAvD_BwE) is Google's backend system that allows developers to store data and manage authentification. It is being used for the backend part of this project. Its main advantages include:
- Database
- Storage
- Authentification
- Crash reports
